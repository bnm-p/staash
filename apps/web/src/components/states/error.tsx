...
interface IErrorStateProps extends ComponentProps<"div"> {
	title: string;
	description: string;
	containerClassName?: string;
}

export const ErrorState: FC<IErrorStateProps> = ({ className, title, description, containerClassName, children, ...props }) => {
	return (
		<div className={cn("flex w-full flex-col items-center gap-6 p-6", className)} {...props}>
			<div className="flex h-12 w-12 items-center justify-center rounded-md border border-destructive/25 bg-destructive/10 p-2 shadow-sm">
