...
>(({ className, ...props }, forwardedRef) => {
	return (
		<DrawerPrimitives.Description ref={forwardedRef} className={cn("text-gray-500 dark:text-gray-500", className)} {...props} />
	);
});
...
const DrawerFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => {
	return (
		<div
			className={cn("flex flex-col-reverse border-border border-t pt-4 sm:flex-row sm:justify-end sm:space-x-2", className)}
			{...props}
		/>
	);
};
