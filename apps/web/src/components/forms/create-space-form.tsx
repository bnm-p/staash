              ...
              <FormItem>
                ...
                <FormControl className="flex items-stretch">
                  <div className="max-w-md">
                    <div className="px-4 py-2 bg-muted border border-r-0 border-border text-muted-foreground text-sm flex items-center">staash.app/{activeOrganization?.slug}/</div>
                    <Input
                      type=""
